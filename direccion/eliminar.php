    ...
    <table border="1">
      ...
      <?php  while ($row = $result->fetch_assoc()) {
        ...
        <tr>
          ...
          ?></td>
          <td> <a href="eliminar.php?RFC=<?php echo $row['RFC']?>">eliminar</a> </td>
        </tr>
      <?php } ?>
    <?php } ?>
...
<?php
  ...
  if (isset($_GET['RFC'])) {
    $variable = $_GET['RFC'];
    $sql1 = "UPDATE direcciones SET Bandera = 0 WHERE RFC='$variable'";//consultamos los tipos de usuario existentes, se usa para el registro
