<?php
  ...
  $sql = "SELECT * FROM venta";//consultamos los tipos de usuario existentes, se usa para el registro
...
<body>
  <h1>Ventas</h1><br>
    <table>
      ...
      <?php  while ($row = $result->fetch_assoc()) {
        ...
        <tr>
          ...
          <td><a href="detalleVenta.php?Folio=<?php echo $row['Folio']?>">Detalle de la Venta</a></td>
    ...
    <br><br>
    <a class="btn btn-warning" href="iniciov.php">Regresar</a>
