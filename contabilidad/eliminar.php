  ...
  <table>
    <thead>
      ...
      <?php  while ($row = $result->fetch_assoc()) {
        ...
        <tr>
          ...
          <td> <a href="eliminar.php?Id_Cuenta=<?php echo $row['Id_Cuenta']?>">Eliminar cuenta</a> </td>
        </tr>
      <?php } ?>
    <?php } ?>
    ...
    <?php
      ...
      if (isset($_GET['Id_Cuenta'])) {
        $variable = $_GET['Id_Cuenta'];
        $sql1 = "UPDATE cuentas SET Bandera = 0 WHERE Id_Cuenta='$variable'";//consultamos los tipos de usuario existentes, se usa para el registro
